<%-- 
    Document   : show
    Created on : Sep 22, 2016, 12:10:03 PM
...
<html>
    <head>
        ...
        <title><s:message code="customer.show.label"/></title>
    </head>
    <body>
        <div class="container">
            <div class="row">
                <legend><s:message code="customer.show.label"/></legend>
                ...
                <c:url var="action" value="/customer/edit/${customer.id}"/>
                <form:form modelAttribute="customer" method="post" action="${action}" class="form-horizontal">
                    <form:hidden path="id" />
